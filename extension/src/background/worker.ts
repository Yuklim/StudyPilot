import { FETCH_IMAGE, MAX_IMAGE_BYTES, isSafeImageUrl, matchPatternFor } from '../shared/protocol'
...
export async function fetchImage(
  ...
  const permitted = await (deps.hasPermission ?? granted)(matchPatternFor(new URL(url)))
