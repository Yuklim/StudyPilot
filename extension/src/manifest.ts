...
export const manifest: Manifest = {
  ...
  description:
    '把你正在看的网页保存到本机 StudyPilot：是文献就抓它自己声明的 PDF，普通网页存正文。只读取已显示的内容，不接触任何网站账号。',
  ...
  // 按 Chromium 的权限警告表它不产生安装提示，但**本次没有实测**——加载已解压扩展
  // 不走安装对话框，自动化也触发不了它。用户重新加载后若看到新的权限提示，以实际为准。
