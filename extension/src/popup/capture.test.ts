...
import { extractedPayload, runCapture, type CaptureBridge } from './capture'
...
describe('runCapture', () => {
  it('subscribes before injecting, then stashes and opens the confirm page', async () => {
    ...
    expect(calls).toEqual(['subscribe', 'inject', 'stash', 'open', 'unsubscribe'])
  })
